...
GQ.py -op GQ/ -on SETINDEX -psf setup/Q12486_clean_ca.psf -cor setup/Q12486_clean_ca.cor -dcd SETINDEX_prod.dcd -sec setup/secondary_struc_defs.txt --aa setup/Q12486_clean.pdb -t 4
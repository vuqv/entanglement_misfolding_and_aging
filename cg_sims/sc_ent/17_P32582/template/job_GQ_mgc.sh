...
GQ.py -op GQ/ -on SETINDEX -psf setup/P32582_clean_ca.psf -cor setup/P32582_clean_ca.cor -dcd SETINDEX_prod.dcd -sec setup/secondary_struc_defs.txt --aa setup/P32582_clean.pdb -t 4
